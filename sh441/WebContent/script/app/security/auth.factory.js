(function() {
    ...
    angular
    	...
    	AuthFactory.$inject = ['$log', '$q', '$firebaseAuth', '$firebaseArray', '$firebaseObject', 'BaseFactory'];
    
    	function AuthFactory($log, $q, $firebaseAuth, $firebaseArray, $firebaseObject, BaseFactory) {
